...
/**
 * Request DTO used to update an existing platform configuration.
 *
 * <p>Contains mutable configuration fields, platform settings, operational toggles,
 * and optional updater audit metadata. Enumerated values are represented as
 ...
 * dynamically resolves the updater from the authenticated {@code SecurityContextHolder}
 * (defaulting to {@code "admin"}).</p>
 */
public record PlatformConfigurationUpdateRequest(
		...
		/**
		 * Current status of the platform configuration.
		 */
