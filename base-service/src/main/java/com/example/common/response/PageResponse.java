...
/**
 * Standard Paginated Response envelope wrapping Spring Data's Page into a serializable DTO.
 */
public class PageResponse<T> {
    ...
    /**
     * Convenience factory method — creates a PageResponse directly from a Spring Data Page.
     */
