 ...
 * Feature controllers should extend this class and annotate with @RequestMapping.
 *
 * @param <T>       Entity type
...
public abstract class AbstractController<T, ID, REQ_DTO, RES_DTO> {
    ...
    /** Validates the ID path variable is non-null and positive (for numeric IDs). */
    ...
    /** Returns the username of the currently authenticated user from SecurityContextHolder. */
    ...
    /** Returns the active tenant identifier from TenantContext. */
